 ...
 */
@ModelClassInfo(tableName = "souvenir_categories",
        tableStoredProcedures = {"insertCategory", "updateCategory", "deleteCategoryById", "getCategoryById", "getCategoryByNameLike", "getAllCategories"})
public class SouvenirCategory {
    ...
    public boolean equals(Object o) {
        ...
        if (souvenirCategoryId != null ? !souvenirCategoryId.equals(that.souvenirCategoryId) : that.souvenirCategoryId != null)
            return false;
