...
public class AdminPieceConstants {
	...
	public static final String SOUVENIR_PIECE_INSERT_URL = ROOT + SOUVENIR_PIECE + ROOT + SOUVENIR_PIECE_OP_INSERT;
	public static final String SOUVENIR_PIECE_INSERT_INTERNAL = SOUVENIR_PIECE_INTERNAL_FOLDER + ROOT
